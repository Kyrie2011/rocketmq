...
public class DefaultMQPushConsumerImpl implements MQConsumerInner {
    ...
    public void pullMessage(final PullRequest pullRequest) {
        ...
        if (MessageModel.CLUSTERING == this.defaultMQPushConsumer.getMessageModel()) {
            // 从Consumer端内存中获取commitOffsetValue
    ...
    public void sendMessageBack(MessageExt msg, int delayLevel, final String brokerName)
        ...
        try {
            ...
            MessageAccessor.putProperty(newMsg, MessageConst.PROPERTY_RETRY_TOPIC, msg.getTopic());  // 新的topic为 %RETRY%+ConsumeGroupName
    ...
    public synchronized void start() throws MQClientException {
        switch (this.serviceState) {
            case CREATE_JUST:
                ...
                this.rebalanceImpl.setmQClientFactory(this.mQClientFactory); // MQClientInstance
        ...
        try {
            ...
            switch (this.defaultMQPushConsumer.getMessageModel()) {
                case BROADCASTING:
                    break;
                case CLUSTERING:
                    // 集群模式下，消费者还需订阅重试topic，retryTopic = ${RETRY_GROUP_TOPIC_PREFIX} + ${consumerGroup}
    ...
    public void resetRetryAndNamespace(final List<MessageExt> msgs, String consumerGroup) {
        ...
        for (MessageExt msg : msgs) {
            String retryTopic = msg.getProperty(MessageConst.PROPERTY_RETRY_TOPIC);  // 从RERTY_TOPIC属性中获取原始的topic
            if (retryTopic != null && groupTopic.equals(msg.getTopic())) {
                msg.setTopic(retryTopic); // 还原Topic
            }
